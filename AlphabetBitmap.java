...
public class AlphabetBitmap {
            ...
            for (int i = 0; i < 7 ; i++) {//Traverse Columns
                for (int j = 0; j < 7; j++) {//Traverse Rows
                    if (bitmap.getPixel(i, j) == 1) //Compare bitmap
                        figures.putPixel(x + (j * pixelSize), y + (i * pixelSize), color, pixelSize);
                    else
                        figures.putPixel(x + (j * pixelSize), y + (i * pixelSize), Color.white, pixelSize);
                }
            }
        }
    }
    ...
    private void initializeLetters(){
        ...
        // Letra B
        alphabet.put('b', new Bitmap( new int[][]  {
                {1, 1, 1, 1, 1, 0, 0}, // 01 row
                {1, 1, 0, 0, 0, 1, 1}, // 02 row
                {1, 1, 0, 0, 0, 1, 1}, // 03 row
                {1, 1, 1, 1, 1, 0, 0}, // 04 row
                {1, 1, 0, 0, 0, 1, 1}, // 05 row
                {1, 1, 0, 0, 0, 1, 1}, // 06 row
                {1, 1, 1, 1, 1, 0, 0}, // 07 row
        }));
        ...
        alphabet.put('d', new Bitmap( new int[][]  {
        ...
        alphabet.put('f', new Bitmap( new int[][]  {
                {1, 1, 1, 1, 1, 1, 1}, // 01 row
                {1, 1, 0, 0, 0, 0, 0}, // 02 row
                {1, 1, 0, 0, 0, 0, 0}, // 03 row
                {1, 1, 1, 1, 1, 1, 0}, // 04 row
        ...
        alphabet.put('g', new Bitmap( new int[][]  {
                {0, 1, 1, 1, 1, 1, 0}, // 01 row
                {1, 1, 0, 0, 0, 0, 0}, // 02 row
                {1, 1, 0, 0, 0, 0, 0}, // 03 row
                {1, 1, 0, 0, 1, 1, 1}, // 04 row
                {1, 1, 0, 0, 0, 0, 1}, // 05 row
                {1, 1, 0, 0, 0, 0, 1}, // 06 row
                {0, 1, 1, 1, 1, 1, 0}, // 07 row
        
        }));

        alphabet.put('h', new Bitmap( new int[][]  {
        ...
        alphabet.put('j', new Bitmap( new int[][]  {
                {0, 0, 0, 0, 0, 1, 1}, // 01 row
                {0, 0, 0, 0, 0, 1, 1}, // 02 row
        ...
        alphabet.put('k', new Bitmap( new int[][]  {
                {1, 1, 0, 0, 1, 1, 0}, // 01 row
                {1, 1, 0, 1, 1, 0, 0}, // 02 row
                {1, 1, 1, 1, 0, 0, 0}, // 03 row
                {1, 1, 1, 1, 0, 0, 0}, // 04 row
                {1, 1, 0, 1, 1, 0, 0}, // 05 row
        ...
        alphabet.put('m', new Bitmap( new int[][]  {
                {1, 0, 0, 0, 0, 0, 1}, // 01 row
                {1, 1, 0, 0, 0, 1, 1}, // 02 row
                {1, 1, 1, 0, 1, 1, 1}, // 03 row
                {1, 0, 1, 1, 1, 0, 1}, // 04 row
                {1, 0, 0, 1, 0, 0, 1}, // 05 row
                {1, 0, 0, 1, 0, 0, 1}, // 06 row
                {1, 0, 0, 1, 0, 0, 1}, // 07 row
        }));
        ...
        alphabet.put('q', new Bitmap( new int[][]  {
                {0, 1, 1, 1, 1, 1, 0}, // 01 row
                {1, 1, 0, 0, 0, 1, 1}, // 02 row
                {1, 1, 0, 0, 0, 1, 1}, // 03 row
                {1, 1, 0, 0, 0, 1, 1}, // 04 row
        ...
        alphabet.put('u', new Bitmap( new int[][]  {
                {1, 1, 0, 0, 0, 1, 1}, // 01 row
                {1, 1, 0, 0, 0, 1, 1}, // 02 row
                {1, 1, 0, 0, 0, 1, 1}, // 03 row
                {1, 1, 0, 0, 0, 1, 1}, // 04 row
        ...
        alphabet.put('w', new Bitmap( new int[][]  {
                {1, 0, 0, 0, 0, 0, 1}, // 01 row
                {1, 0, 0, 0, 0, 0, 1}, // 02 row
                {1, 0, 1, 0, 1, 0, 1}, // 03 row
                {1, 0, 1, 0, 1, 0, 1}, // 04 row
                {1, 1, 0, 1, 0, 1, 1}, // 05 row
                {1, 1, 0, 1, 0, 1, 1}, // 06 row
                {0, 1, 1, 0, 1, 1, 0}, // 07 row
        ...
        alphabet.put(',', new Bitmap( new int[][] {
                ...
                {0, 0, 0, 0, 0, 0, 0}, // 02 row
                {0, 0, 0, 0, 0, 0, 0}, // 03 row
                {0, 0, 0, 0, 0, 0, 0}, // 04 row
                {0, 0, 0, 0, 0, 1, 0}, // 05 row
                {0, 0, 0, 0, 1, 0, 0}, // 06 row
                {0, 0, 0, 0, 0, 0, 0}, // 07 row
        }));
